...
<section>
    ...
    <form method="post" action="/meals/filter">
        ...
        <button type="submit"><spring:message code="meal.filterButtonText"/></button>
    </form>
    <hr/>
    <form method="get" action="/meals/create">
        <input type="submit" value=<spring:message code="meal.create"/>>
    </form>
    <hr/>
    <table border="1" cellpadding="8" cellspacing="0">
        <thead>
        <tr>
            <th><spring:message code="mealForm.dateTime"/></th>
            <th><spring:message code="mealForm.description"/></th>
            <th><spring:message code="mealForm.calories"/></th>
            <th></th>
            <th></th>
        </tr>
        </thead>
